            ...
            <div class="container">
                <div class="col-md-12 col-md-offset-0">
                    <div class="animate-box">
                        <h2><span style = "font-weight:100;"><?php echo $lang['judulwhatmakes'];?></span></h2>
                        <p class="breadcrumbs"><span><a href="index.php"><?php echo $lang['home'];?></a></span><span><strong><?php echo $lang['tagwhatmakes'];?></strong></span></p>
                    </div>
                </div>
            </div>
        </div>
