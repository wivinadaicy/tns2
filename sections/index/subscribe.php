<div id="colorlib-subscribe" class="colorlib-subscribe" style="background-image: url(<?php echo base_url();?>assets/images/cover_img_1.jpg);" data-stellar-background-ratio="0.5">
