<section id="home" class="video-hero" style="height: 700px; background-image: url(<?php echo base_url();?>assets/images/cover_img_1.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;" data-section="home">
